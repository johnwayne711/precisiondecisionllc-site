...
const CACHE_NAME = "verify-app-v123";
const APP_ASSETS = [
  "./",
  "./index.html",
  "./styles.css",
  ...
  "./lathe-stock.mjs",
  "./lathe-cutter-edges.mjs",
  "./lathe-controller-settings.mjs",
  "./lathe-compensation.mjs",
  "./tool-lathe-cutting.mjs",
  "./compare.mjs",
  "./dxf-import.mjs",
  "./profile-compare.mjs",
  ...
  "./tool-cad-left-projection.mjs",
  "./tool-cad-d-projection.mjs",
  "./tool-cad-v-projection.mjs",
  "./tool-cad-boring-projection.mjs",
  "./tool-cad-od-groove-projection.mjs",
  "./tool-cad-face-groove-projection.mjs",
  "./tool-cad-id-thread-projection.mjs",
  "./tool-cad-partoff-projection.mjs",
  "./tool-cad-od-thread-projection.mjs",
  "./tool-cad-id-groove-projection.mjs",
  "./tool-partoff-nominal.mjs",
  "./tool-profile-catalog.mjs",
  "./tool-profile-display.mjs",
  "./tool-profile-sources.mjs",
  "./tool-library.mjs",
  ...
  "./live-view.mjs",
  "./live-stock.mjs",
  "./live-section-stock.mjs",
  "./declared-cutters.mjs",
  "./runtime.mjs",
